...
public class ViewCard extends ViewBase {

	protected String strName;
	protected Card oThisCard;
	Grid oCurrentTypeAttrGrid = null;

	public ViewCard( ViewMaster master, String strName ) {
		super( master );
		this.strName = strName;
	}
/*
		oThisCard = master.getObjectFactory().getCard( strName );
		int iLevels = oThisCard.getLevel()+1;
